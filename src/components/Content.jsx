                    ...
                    <div className="flex w-full justify-center items-end">
                        <div className="relative mr-4 lg:w-full xl:w-1/2 w-2/4 md:w-full text-left">
                            <label htmlFor="hero-field" className="leading-7 text-sm text-gray-600">
                                Ingrese el Emoji que desea obtener
                            </label>
                            <input
                                type="text"
                                id="hero-field"
                        ...
                        <button className="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">Buscar</button>
                    </div>
                    <p className="text-sm mt-2 text-gray-500 mb-8 w-full">Buscador de Emojis.</p>
                    <div className="flex">
